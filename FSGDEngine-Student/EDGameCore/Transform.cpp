...
namespace EDGameCore
{
	...
	void Transform::TranslateLocal(const Float3& translation)
	{
		...
		localMatrix.WAxis += worldMatrix.XAxis * translation.x;
		localMatrix.WAxis += worldMatrix.YAxis * translation.y;
		localMatrix.WAxis += worldMatrix.ZAxis * translation.z;
	...
	void Transform::TranslateGlobal(const Float3& translation)
	{
		...
		worldMatrix.WAxis.x += translation.x * WorldData::GetDeltaTime();
		worldMatrix.WAxis.y += translation.y * WorldData::GetDeltaTime();
		worldMatrix.WAxis.z += translation.z * WorldData::GetDeltaTime();
