...
private:
	...
	EDUtilities::ContentHandle<EDRendererD3D::RenderContext> shadowMappingContextHandle;
	EDUtilities::ContentHandle<EDRendererD3D::RenderContext> shadowMappingSkinnedContextHandle;
	...
	/// Class object used for managing when the GBuffer are active as shader resources
	GBufferEffectHandler gBufferTextureHandler;
...
public:
	...
	EDUtilities::ContentHandle<EDRendererD3D::RenderContext> &GetShadowMappingContextHandle()
	{
		return shadowMappingContextHandle;
	}

	EDUtilities::ContentHandle<EDRendererD3D::RenderContext> &GetShadowMappingSkinnedContextHandle()
	{
		return shadowMappingSkinnedContextHandle;
	}
